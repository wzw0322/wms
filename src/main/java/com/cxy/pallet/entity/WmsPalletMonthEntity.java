 ...
 */
@Entity
@Table(name = "wms_pallet_month", schema = "")
@SuppressWarnings("serial")
public class WmsPalletMonthEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="PALLET_MATERIAL",nullable=true,length=11)
	 ...
	 */
	@Column(name ="PALLET_TYPE",nullable=true,length=11)
