		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
	            	<t:dictSelect field="whId" readonly="readonly" defaultVal = "${wmsWarePosition.whId}" type="select" hasLabel="false" title="仓库名称" extendJson="{class:'form-control'}"  datatype="*"  dictTable="wms_ware_house" dictField="id" dictText="house_name" dictCondition="where isdel=0"></t:dictSelect>
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
