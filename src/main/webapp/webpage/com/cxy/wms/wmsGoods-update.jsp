...
<t:base type="bootstrap,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="wmsGoodsController.do?doUpdate" method="POST">
		<input type="hidden" id="btn_sub" class="btn_sub"/>
		<input type="hidden" id="id" name="id" value="${wmsGoods.id}"/>
	<div class="form-group">
		<label for="goodsCode" class="col-sm-3 control-label">货物编码：</label>
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="goodsCode" name="goodsCode" value='${wmsGoods.goodsCode}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入货物编码"  datatype="*" ignore="checked" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="goodsName" name="goodsName" value='${wmsGoods.goodsName}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入货物名称"  datatype="*" ignore="checked" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
               <t:dictSelect field="goodsStatus" type="list" extendJson="{class:'form-control input-sm'}"  datatype="*"  typeGroupCode="wh_simple"  hasLabel="false"  title="货物状态" defaultVal="${wmsGoods.goodsStatus}"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="goodsKeep" name="goodsKeep" value='${wmsGoods.goodsKeep}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入保质期"  datatype="*" ignore="checked" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
               <t:dictSelect field="goodsUnit" type="list" extendJson="{class:'form-control input-sm'}"  datatype="*"  dictTable="wms_unit" dictField="id" dictText="unit_name"  hasLabel="false"  dictCondition="where isdel=0 and unit_status=1" title="单位" defaultVal="${wmsGoods.goodsUnit}"></t:dictSelect>
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea name="goodsDes" class="form-control input-sm" rows="6"  ignore="ignore" >${wmsGoods.goodsDes}</textarea>
