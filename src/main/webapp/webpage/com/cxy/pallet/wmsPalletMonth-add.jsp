...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wmsPalletMonthController.do?doAdd" tiptype="1" >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>时间：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="countDate" name="countDate" maxlength="32" type="text" class="form-control"  ignore="ignore" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
